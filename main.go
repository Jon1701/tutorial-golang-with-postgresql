...
import (
	...
	"github.com/Jon1701/tutorial-golang-with-postgresql/models"
	"github.com/Jon1701/tutorial-golang-with-postgresql/storage"
...
func (r *Repository) CreateBook(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(&fiber.Map{"message": "book created"})
	return nil
}
